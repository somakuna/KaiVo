    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header h5 bg-success bg-gradient text-white"><strong>EDIT</strong> BIKE Service</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('bikeService.update', $bikeService) }}" enctype="multipart/form-data" autocomplete="on">
                        @csrf
                        @method('PUT')
                        <div class="row g-3">
                            <div class="col-md-8">
                                ...
                                <input
                                    ...
                                    name="name"
                                    type="text"
                                    value="{{ old('name', $bikeService->name) }}"
                            ...
                            <div class="col-md-2">
                                ...
                                <input
                                    ...
                                    name="bike_price"
                                    type="number"
                                    value="{{ old('bike_price', $bikeService->bike_price) }}"
                                    step="0.01"
                            ...
                            <div class="col-md-2">
                                ...
                                <input
                                    id="finish_time"
                                    name="finish_time"
                                    value="{{ old('finish_time', $bikeService->finish_time) }}"
                                    type="text"
