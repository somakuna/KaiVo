                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{ route('bikes.show', $bike) }}" title="Show">{{ $bike->number }}</a></td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('bikes.show', $bike) }}" title="Show" class="btn btn-outline-success"><i class="bi bi-box-arrow-in-right"></i></a>
                                            <a href="{{ route('pdf.show', [$bike, 1]) }}" title="PDF A5" class="btn btn-outline-primary"><i class="bi bi-printer"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
