    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card shadow-sm">
                <div class="card-header h5 bg-primary bg-gradient text-white"><strong>CREATE NEW</strong> TOUR Service</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('tourService.store') }}" enctype="multipart/form-data" autocomplete="on">
                        @csrf
                        <div class="row g-3">
                            <div class="col-md-6">
