                    ...
                    <div class="table-responsive">
                        ...
                        >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><a href="{{ route('tours.show', $tour) }}" title="Show">{{ $tour->number }}</a></td>
                                    <td>{{ $tour->date->format('d.m.Y.') }}</td>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm" role="group">
                                            <a href="{{ route('tours.show', $tour) }}" title="Show" class="btn btn-outline-success"><i class="bi bi-box-arrow-in-right"></i></a>
                                            <a href="{{ route('pdf.show', [$tour, 1]) }}" title="PDF A5" class="btn btn-outline-primary"><i class="bi bi-printer"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
